...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO usuarios (usuario, clave,fechaBaja,ocupacion,fechaAlta,mesaOcupada,edad) VALUES (:usuario, :clave, :fechaBaja, :ocupacion, :fechaAlta, :mesaOcupada, :edad)");
